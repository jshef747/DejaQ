...
| `DEJAQ_CACHE_IMAGE_OCR_MIN_CONFIDENCE` | `60.0` | Mean OCR word confidence required to treat an image as a document. Swept 50–80: 0 false merges at every level, so this only routes — the 0.80 token threshold carries the safety |
